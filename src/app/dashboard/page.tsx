      ...
      <Card className="overflow-hidden">
        <div className="grid md:grid-cols-2">
            <div className="p-8 md:p-10 flex flex-col justify-center">
                <h1 className="font-headline text-3xl md:text-4xl font-bold text-primary">{t('welcome_user', { name: name })}</h1>
                ...
                <div className="mt-6">
                    <Link href="/dashboard/goals">
                        <Button size="lg" className="group">
                            {t('set_first_goal')} <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                        </Button>
                    </Link>
                </div>
            </div>
